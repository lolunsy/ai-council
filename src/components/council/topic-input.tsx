      ...
      <div className="rounded-[22px] border border-white/8 bg-[#0a1628]/80 p-3">
        ...
        <div className="mt-3 flex items-center justify-between gap-4 border-t border-white/8 px-2 pt-3">
          <div className="space-y-1">
            ...
            <p className="text-xs text-white/30">当前阶段仅启用前端交互，不进入真实会议流程</p>
          </div>

          <button
            type="button"
            disabled={!canStart}
            className="inline-flex h-11 items-center justify-center rounded-2xl border border-cyan-300/20 bg-cyan-400/15 px-5 text-sm font-medium text-cyan-100 transition hover:bg-cyan-400/20 disabled:cursor-not-allowed disabled:border-white/10 disabled:bg-white/5 disabled:text-white/35"
          >
            开始开会
          </button>
        </div>
